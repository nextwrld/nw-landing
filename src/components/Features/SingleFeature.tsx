  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary mx-auto">
        ...
        <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-11 text-center">
          {paragraph}
        </p>
      </div>
    </div>
